...
if __name__ == '__main__':
    ...
    original_folders['IMG_ROOT'] = '/data/kitti/3d_vision/data/KITTI/training/image_2/'
    original_folders['PC_ROOT'] = '/data/kitti/3d_vision/data/KITTI/training/velodyne/'
    original_folders['LABEL_ROOT'] = '/data/kitti/3d_vision/data/KITTI/training/label_2/'

    # Modified folder
    train_folders = dict()
    train_folders['IMG_ROOT'] = '/data/kitti/3d_vision/data/MD_KITTI/training/image_2/'
    train_folders['PC_ROOT'] = '/data/kitti/3d_vision/data/MD_KITTI/training/velodyne/'
    train_folders['LABEL_ROOT'] = '/data/kitti/3d_vision/data/MD_KITTI/training/label_2/'

    val_folders = dict()
    val_folders['IMG_ROOT'] = '/data/kitti/3d_vision/data/MD_KITTI/validation/image_2/'
    val_folders['PC_ROOT'] = '/data/kitti/3d_vision/data/MD_KITTI/validation/velodyne/'
    val_folders['LABEL_ROOT'] = '/data/kitti/3d_vision/data/MD_KITTI/validation/label_2/'

    # Split file
    train_split_file = '/data/kitti/3d_vision/data/KITTI/ImageSets/train.txt'
    val_split_file = '/data/kitti/3d_vision/data/KITTI/ImageSets/val.txt'
